...
import com.example.playlistmaker.search.ui.SearchActivity.Companion.EXTRA_PREVIEW
...
class MediaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent = intent
        val repository: MediaRepository? = intent?.let { Creator.createMediaRepository(it) }
        if (repository != null) {
