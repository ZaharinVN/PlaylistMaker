...
class PlayerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.observeIsFavorite.observe(viewLifecycleOwner) { isFavorite ->
            val dislikeIcon = if (isDarkTheme()) R.drawable.ic_dislike_dark else R.drawable.ic_dislike
            val favoriteIcon = if (isDarkTheme()) R.drawable.ic_favorite_dark else R.drawable.ic_favorite
